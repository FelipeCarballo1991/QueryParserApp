...
PALABRAS_RESERVADAS = ['ADD','LEFT','ON' ,'EXTERNAL', 'PROCEDURE', 'ALL', 'FETCH', 'PUBLIC', 
...
'BROWSE', 'GRANT', 'REVOKE', 'BULK', 'GROUP', 'RIGHTT', 'BY', 
...
'SCHEMA', 'CLUSTERED', 'IN', 'SECURITYAUDIT', 
'COALESCE', 'INDEX', 'SELECT', 'COLLATE', 'INNNER', 
...
'CONTINUE', 'KILL', 'SOME', 'CONVERT', 'STATISTICS', 'CREATE', 'LIKE', 'SYSTEM_USER', 
...
'OFFSETS', 'TSEQUAL', 'DELETE', 'ONN', 'UNION', 'DENY', 'OPEN', 'UNIQUE', 'DESC', 'OPENDATASOURCE', 
'UNPIVOT', 'DISK', 'OPENQUERY', 'UPDATE', 'DISTINCT', 'OPENROWSET', 'UPDATETEXT', 'DISTRIBUTED', 
'OPENXML', 'USE', 'DOUBLE', 'OPTION', 'USER', 'DROP', 'OR', 'VALUES', 'DUMP', 'ORDER', 'VARYING', 
'ELSE', 'OUTERR', 'VIEW', 'END', 'OVER', 'WAITFOR', 'ERRLVL', 'PERCENT', 'WHEN', 'ESCAPE', 
